...
def make_histograms(info):
    ...
    h.make("sel_e1_corrDxy",'dxy')
    h.make("sel_e1_corrDxySignif",'dxy_signif')
    h.make("sel_e1_trkChi2",'trk_chi2')
    h.make("sel_e1_corrChi2",'trk_chi2')
    ...
    h.make("sel_e2_corrDxy",'dxy')
    h.make("sel_e2_corrDxySignif",'dxy_signif')
    h.make("sel_e2_trkChi2",'trk_chi2')
    h.make("sel_e2_corrChi2",'trk_chi2')
    ...
    h.make("sel_vtx_mass_med_vs_vxy","vtx_mass","vxy10")
    h.make("sel_vtx_mass_long_vs_vxy","vtx_mass_long","vxy10")
    h.make("sel_vtx_mass_high_vs_vxy","vtx_mass_high","vxy10")
    
    h.make("sel_vtx_mass_vs_vxy20","mass_low","vxy20")
    h.make("sel_vtx_mass_med_vs_vxy20","vtx_mass","vxy20")
    h.make("sel_vtx_mass_long_vs_vxy20","vtx_mass_long","vxy20")
    h.make("sel_vtx_mass_high_vs_vxy20","vtx_mass_high","vxy20")
    
    h.make("sel_vtx_corrMass_vs_vxy","mass_low","vxy10")
    h.make("sel_vtx_corrMass_med_vs_vxy","vtx_mass","vxy10")
    h.make("sel_vtx_corrMass_long_vs_vxy","vtx_mass_long","vxy10")
    h.make("sel_vtx_corrMass_high_vs_vxy","vtx_mass_high","vxy10")
    
    h.make("sel_vtx_corrMass_vs_vxy20","mass_low","vxy20")
    h.make("sel_vtx_corrMass_med_vs_vxy20","vtx_mass","vxy20")
    h.make("sel_vtx_corrMass_long_vs_vxy20","vtx_mass_long","vxy20")
    h.make("sel_vtx_corrMass_high_vs_vxy20","vtx_mass_high","vxy20")
...
def fillHistos(events,h,samp,cut,info,sum_wgt=1):
    ...
    h.fill("sel_e1_corrDxy",dxy=sel_vtx.e1_refit_dxy,weight=wgt)
    h.fill("sel_e1_corrDxySignif",signif=np.abs(sel_vtx.e1_refit_dxy)/sel_vtx.e1_refit_dxyErr,weight=wgt)
    h.fill("sel_e1_trkChi2",chi2=sel_vtx.e1.trkChi2,weight=wgt)
    h.fill("sel_e1_corrChi2",chi2=sel_vtx.e1_refit_chi2,weight=wgt)
    ...
    h.fill("sel_e2_corrDxy",dxy=sel_vtx.e2_refit_dxy,weight=wgt)
    h.fill("sel_e2_corrDxySignif",signif=np.abs(sel_vtx.e2_refit_dxy)/sel_vtx.e2_refit_dxyErr,weight=wgt)
    h.fill("sel_e2_trkChi2",chi2=sel_vtx.e2.trkChi2,weight=wgt)
    h.fill("sel_e2_corrChi2",chi2=sel_vtx.e2_refit_chi2,weight=wgt)
    ...
    h.fill("sel_vtx_mass_med_vs_vxy",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_mass_long_vs_vxy",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_mass_high_vs_vxy",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    
    h.fill("sel_vtx_mass_vs_vxy20",mass_low=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_mass_med_vs_vxy20",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_mass_long_vs_vxy20",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_mass_high_vs_vxy20",mass=sel_vtx.m,vxy=sel_vtx.vxy,weight=wgt)
    
    h.fill("sel_vtx_corrMass_vs_vxy",mass_low=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_med_vs_vxy",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_long_vs_vxy",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_high_vs_vxy",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    
    h.fill("sel_vtx_corrMass_vs_vxy20",mass_low=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_med_vs_vxy20",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_long_vs_vxy20",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
    h.fill("sel_vtx_corrMass_high_vs_vxy20",mass=sel_vtx.refit_m,vxy=sel_vtx.vxy,weight=wgt)
