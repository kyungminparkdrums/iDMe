...
class myHisto:
    def __init__(self):
        ...
        self.met = self.parse_axis(('met',100,0,300))
        ...
        self.ele_pt_fine = self.parse_axis(("pt",500,0,50))
        ...
        self.eta = self.parse_axis(('eta',100,-4,4))
        ...
        self.jet_pt = self.parse_axis(('jet_pt',220,80,300))
