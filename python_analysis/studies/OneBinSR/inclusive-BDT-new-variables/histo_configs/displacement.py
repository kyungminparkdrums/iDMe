...
def make_histograms():
    histograms = {
        ...
        "sel_vtx_pt_e1_over_pt_e2": Hist(samp,cut,ratio_big,storage=hist.storage.Weight()),
        "delta_dxy_over_mindxy": Hist(samp,cut,ratio_big,storage=hist.storage.Weight()),
        "delta_dxy_over_maxdxy": Hist(samp,cut,ratio_big,storage=hist.storage.Weight()),
...
def fillHistos(events,histos,samp,cut,info,sum_wgt=1):
    ...
    histos["sel_vtx_pt_e1_over_pt_e2"].fill(samp=samp,cut=cut,ratio_big=e1.pt/e2.pt,weight=wgt)
    ...
    histos["delta_dxy_over_maxdxy"].fill(samp=samp,cut=cut,ratio_big=delta_dxy/max_dxy,weight=wgt)
