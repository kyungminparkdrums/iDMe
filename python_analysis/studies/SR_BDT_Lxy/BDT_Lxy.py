...
def cut10(events,info):
    ...
    #print(events["sel_vtx","vxy"])

    #print(vxy_mask)

    thres_high_vxy = 0.9696
    thres_low_vxy = 0.8975
    ...
    if len(events) != 0:
        ...
        #print(score_BDT_high_vxy)
        #print(ak.fill_none(ak.mask(score_BDT_high_vxy, vxy_mask), 0) + ak.fill_none(ak.mask(score_BDT_low_vxy, ~vxy_mask), 0))
