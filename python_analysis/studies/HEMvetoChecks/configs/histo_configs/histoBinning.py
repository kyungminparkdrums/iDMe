...
class myHisto:
    def __init__(self):
        ...
        self.vxFromPV1 = self.parse_axis(('vxFromPV',100,0,1))
        self.vxFromPV10 = self.parse_axis(('vxFromPV',100,0,10))
        self.vxFromPV100 = self.parse_axis(('vxFromPV',100,0,100))
        self.vyFromPV1 = self.parse_axis(('vyFromPV',100,0,1))
        self.vyFromPV10 = self.parse_axis(('vyFromPV',100,0,10))
        self.vyFromPV100 = self.parse_axis(('vyFromPV',100,0,100))

        self.vxyFromPV1 = self.parse_axis(('vxyFromPV',100,0,1))
        self.vxyFromPV10 = self.parse_axis(('vxyFromPV',100,0,10))
        self.vxyFromPV100 = self.parse_axis(('vxyFromPV',100,0,100))
