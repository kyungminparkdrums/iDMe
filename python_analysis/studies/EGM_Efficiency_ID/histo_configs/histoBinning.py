...
class myHisto:
    def __init__(self):
        ...
        self.nPV = self.parse_axis(('nPV',100,0,100))
        ...
        self.reco_type = self.parse_axis(('reco_type',['None','L','R']))
        self.vtx_reco_type = self.parse_axis(('vtype',[0, 1, 2, 3])) # None, LL, RL, RR
        ...
        self.vxy_SFbin = Variable([0,1,10,20],name='vxy_SFbin',label='vxy_SFbin')
        self.vxy_SFbin_coarse = Variable([0,1,20],name='vxy_SFbin_coarse',label='vxy_SFbin_coarse')
        ...
        self.vxy20 = self.parse_axis(('vxy',20,0,20))
