...
def make_histograms():
    histograms = {
        ...
        "cos_collinear3D": Hist(samp,cut,cos_collinear,storage=hist.storage.Weight()),   
...
def fillHistos(events,histos,samp,cut,info,sum_wgt=1):
    ...
    histos['cos_collinear3D'].fill(samp=samp,cut=cut,cos_collinear=events.sel_vtx.cos_collinear3D,weight=wgt)
