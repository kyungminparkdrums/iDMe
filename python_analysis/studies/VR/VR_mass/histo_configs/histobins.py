...
mass = Regular(500,0,100,name="mass",label="$m_{e^+e^-}$ [GeV]")
mass_refit = Regular(500,0,100,name="mass_refit",label="$m_{e^+e^-}$ [GeV]")
...
deta_zoom = Regular(640,0,6.4,name='deta',label="$\Delta \eta$")
...
dphi_zoom = Regular(320,0,3.2,name="dphi",label="$\Delta \phi$")
