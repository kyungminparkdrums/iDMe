...
def make_histograms():
    histograms = {
        ...
        "sel_vtx_dEta_over_dPhi": Hist(samp,cut,ratio_big,storage=hist.storage.Weight()),
        ...
        # check conversion
        "sel_vtx_mass_vs_sel_vtx_dR" : Hist(samp,cut,mass,dR_zoom,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_sel_vtx_vxy" : Hist(samp,cut,mass,vxy,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_sel_vtx_vxySignif" : Hist(samp,cut,mass,vtx_vxySignif,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_sel_vtx_type" : Hist(samp,cut,mass,vtx_type,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_mindxy" : Hist(samp,cut,mass,dxy,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_sel_vtx_dEta" : Hist(samp,cut,mass,deta_zoom,storage=hist.storage.Weight()),
        "sel_vtx_mass_vs_sel_vtx_dPhi" : Hist(samp,cut,mass,dphi_zoom,storage=hist.storage.Weight()),
        ...
        "sel_vtx_dR_vs_bdt_score" : Hist(samp,cut,dR,bdtScore,storage=hist.storage.Weight()),
        ...
        "sel_vtx_dR_zoom_vs_bdt_score" : Hist(samp,cut,dR_zoom,bdtScore,storage=hist.storage.Weight()),
...
def fillHistos(events,histos,samp,cut,info,sum_wgt=1):
    ...
    histos["sel_vtx_dEta_over_dPhi"].fill(samp=samp,cut=cut,ratio_big=np.abs(e1.eta-e2.eta)/np.abs(e1.phi-e2.phi),weight=wgt)
    ...
    histos['projectedLxy'].fill(samp=samp,cut=cut,vxy_projected=events.sel_vtx.projectedLxy,weight=wgt)
    ...
    #histos['sel_vtx_mass_vs_sel_vtx_dR'].fill(samp=samp,cut=cut,mass=vtx.m,dr_zoom=vtx.dR,weight=wgt)
    #histos['sel_vtx_mass_vs_sel_vtx_vxy'].fill(samp=samp,cut=cut,mass=vtx.m,vxy=vtx.vxy,weight=wgt)
    #histos['sel_vtx_mass_vs_sel_vtx_vxySignif'].fill(samp=samp,cut=cut,mass=vtx.m,vxy_signif=vtx.vxy/vtx.sigmavxy,weight=wgt)
    #histos['sel_vtx_mass_vs_sel_vtx_type'].fill(samp=samp,cut=cut,mass=vtx.m,type=vtx.typ,weight=wgt)
    #histos['sel_vtx_mass_vs_mindxy'].fill(samp=samp,cut=cut,mass=vtx.m,dxy=min_dxy,weight=wgt)

    #histos['sel_vtx_mass_vs_sel_vtx_dEta'].fill(samp=samp,cut=cut,mass=vtx.m,deta=np.abs(e1.eta-e2.eta),weight=wgt)
    #histos['sel_vtx_mass_vs_sel_vtx_dPhi'].fill(samp=samp,cut=cut,mass=vtx.m,dphi=np.abs(e1.phi-e2.phi),weight=wgt)
    ...
    histos['sel_vtx_dR_vs_bdt_score'].fill(samp=samp,cut=cut,dr=vtx.dR,bdtScore=events.BDTScore,weight=wgt)
    ...
    histos['sel_vtx_dR_zoom_vs_bdt_score'].fill(samp=samp,cut=cut,dr_zoom=vtx.dR,bdtScore=events.BDTScore,weight=wgt)
